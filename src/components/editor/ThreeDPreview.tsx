    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-slate-950 text-slate-100 select-none overflow-hidden"
      ...
      <Button
        ...
        className={`absolute top-2 ${
          isAr ? "left-2 sm:left-4" : "right-2 sm:right-4"
        } z-50 h-7 w-7 text-blue-400 hover:text-white hover:bg-blue-600/20 border-2 border-blue-500/80 hover:border-blue-400 rounded-lg transition-all flex items-center justify-center shadow-md shadow-blue-500/20`}
      >
        <X className="w-3.5 h-3.5 stroke-[2.5]" />
      </Button>

      <header className={`flex flex-nowrap items-center justify-between gap-1 sm:gap-2 px-2 sm:px-4 py-1.5 bg-slate-900/90 border-b border-slate-800 backdrop-blur-md z-10 ${isAr ? "pl-10 sm:pl-16" : "pr-10 sm:pr-16"}`}>
